...
%%qui desccrivi prima parte dello script
...
%Manca
% summarize the results in terms of  natural frequencies and damping ratios;
...
%TO DO
%- Comparison between experimental and numerical FRFs . Scegliamo un modo e una misurazione e facciamo vedere che funziona. Possiamo farlo vedere per più casi. (sez 3a)
%- sezione 3b - summarize the results in terms of natural frequencies and damping ratios; (vedi ass amici nostri)
